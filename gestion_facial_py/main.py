...
#Leer las miamgenes
img_info = cv2.imread("C:/laragon/www/control_asistencia_imprenta_satipo/gestion_facial_py/img/Info.png")
img_check = cv2.imread("C:/laragon/www/control_asistencia_imprenta_satipo/gestion_facial_py/img/check.png")
img_step0 = cv2.imread("C:/laragon/www/control_asistencia_imprenta_satipo/gestion_facial_py/img/Step0.png")
img_step1 = cv2.imread("C:/laragon/www/control_asistencia_imprenta_satipo/gestion_facial_py/img/Step1.png")
img_step2 = cv2.imread("C:/laragon/www/control_asistencia_imprenta_satipo/gestion_facial_py/img/Step2.png")
img_liche = cv2.imread("C:/laragon/www/control_asistencia_imprenta_satipo/gestion_facial_py/img/LivenessCheck.png")
