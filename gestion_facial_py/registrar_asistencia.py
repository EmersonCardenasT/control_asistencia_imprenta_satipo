...
imagenbc = PhotoImage(file="C:/xampp/htdocs/Python/asistencia_dream_li_sac/SetUp/Back3.png")

# Path
# Carpeta de lo usuarios
OutFolderPathUser = 'C:/xampp/htdocs/Python/asistencia_dream_li_sac/Database/Users'
#Esto es para verificar los usuarios
PathUserCheck = 'C:/xampp/htdocs/Python/asistencia_dream_li_sac/Database/Users/'
# carpeta de los rostros
NuevaCarpetaRostros = 'C:/xampp/htdocs/Python/asistencia_dream_li_sac/Assets/img/faces'
OutFolderPathFace = 'C:/xampp/htdocs/Python/asistencia_dream_li_sac/Database/Faces'
